...
CXXFLAGS+=-fwasm-exceptions -pthread -g
...
LDFLAGS+=-sEXIT_RUNTIME=0 -sALLOW_MEMORY_GROWTH=1 -pthread -sPTHREADS_DEBUG -sPTHREAD_POOL_SIZE=4 # pool size is optional but just lets everything init

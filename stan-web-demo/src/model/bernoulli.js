...
function findWasmBinary() {
  if (Module["locateFile"]) {
    return locateFile("bernoulli.wasm");
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL("bernoulli.wasm", import.meta.url).href;
}
...
var PThread = {
  ...
  allocateUnusedWorker() {
    ...
    worker = new Worker(new URL("bernoulli.js", import.meta.url), {
      "type": "module",
...
function assignWasmExports(wasmExports) {
  ...
  _tinystan_model_num_free_params = Module["_tinystan_model_num_free_params"] = wasmExports["tinystan_model_num_free_params"];
  _tinystan_separator_char = Module["_tinystan_separator_char"] = wasmExports["tinystan_separator_char"];
  _tinystan_sample = Module["_tinystan_sample"] = wasmExports["tinystan_sample"];
  _tinystan_get_error_message = Module["_tinystan_get_error_message"] = wasmExports["tinystan_get_error_message"];
  _tinystan_get_error_type = Module["_tinystan_get_error_type"] = wasmExports["tinystan_get_error_type"];
  _tinystan_destroy_error = Module["_tinystan_destroy_error"] = wasmExports["tinystan_destroy_error"];
  _tinystan_api_version = Module["_tinystan_api_version"] = wasmExports["tinystan_api_version"];
  _tinystan_stan_version = Module["_tinystan_stan_version"] = wasmExports["tinystan_stan_version"];
